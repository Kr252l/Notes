			  ...
			  <body>
			    ...
			    <div class="container">
			      <form method="POST">
			        <div class="row">  
			          <div class="col-md-4">
			            <input required name="title" style="height: 42px;" placeholder="Введіть нову назву нотатки" class="form-control">
			            <br>
			            <div class="btn-group" style="width: 100%; height: 42px;" role="group" aria-label="Button group with nested dropdown">
			                <select name="category" style="height: 42px;" class="btn btn-secondary form-control" id="exampleFormControlSelect1">
			                  <option selected >Виберіть нову категорію</option>
			                  <?
			          ...
			          <div class="col-md-7 text-right">
			            ...
			            ?>" required class="form-control" id="exampleFormControlTextarea1" rows="6" placeholder="Введіть нотатку" name="text"></textarea>
			            <br>
