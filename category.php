    ...
    <div class="container">
      <div id="accordion">
        ...
        <div class="card" style="background-color: #999999;">
          ...
          <div id="collapse<? print $name; ?>" class="collapse  " style="background: linear-gradient(to top, #f2f2f2, #999999); padding: 10px; "aria-labelledby="heading<? print $name; ?>" data-parent="#accordion">
            <div class="card-body">
              <?
